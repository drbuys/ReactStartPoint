...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleData = [{ id: 1, author: "Keith", text: "Boom!Boom!" }, { id: 2, author: "Rick", text: "Very Cool..." }, { id: 3, author: "Kat", text: "How do you do!?!?" }];
	...
	var CommentBox = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(CommentList, { data: this.state.data, onCommentDelete: this.handleCommentDelete, __self: this
	            }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentList = React.createClass({
	    ...
	    delCom: function delCom(comment) {
	        return this.props.onCommentDelete(comment);
	    },
	
	    render: function render() {
	        var commentArray = this.props.data.map(function (comment) {
	            return React.createElement(Comment, { author: comment.author, text: comment.text, key: comment.id, deleteMe: this.delCom, __self: this
	            });
	        }.bind(this));
	...
	var Comment = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            this.props.text,
	            React.createElement("input", { onClick: this.handleClick, type: "submit", value: "Delete", __self: this
	            })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { onSubmit: this.handleSubmit, id: 'myForm', __self: this
	            },
